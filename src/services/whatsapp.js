 ...
 * Sem credenciais configuradas, funciona em modo simulado (útil em dev).
 */
...
/** Marca uma mensagem recebida como lida (aparece o "azul" para o cliente). */
...
function verifySignature(rawBody, signatureHeader) {
  if (!wa.appSecret) {
    // Sem app secret, aceita apenas fora de produção
...
module.exports = { isConfigured, sendText, markAsRead, fetchMedia, verifySignature };
