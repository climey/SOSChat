...
- [x] **Etapa 1.11:** Pré-consulta de placa: ao chegar uma placa válida, busca os dados básicos do veículo no Ke Placa (cache de 30 dias, uma busca por vez), mostra o cartão ao atendente e envia a mensagem de confirmação ao cliente com um clique ou automaticamente; modelo da mensagem editável
